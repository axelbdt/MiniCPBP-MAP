...
/**
 * Interface for integer domain implementation. A domain is encapsulated in an
 * {@link IntVar} implementation. A domain is like a set of integers.
 */
public interface IntDomain {
     ...
     *          <ul>
     *          <li>{@link DomainListener#change()} is called if v belongs to the
     *          domain</li>
     *          <li>{@link DomainListener#changeMax()} is called if v is equal to
     *          the maximum value</li>
     *          <li>{@link DomainListener#changeMin()} is called if v is equal to
     *          the minimum value</li>
     *          <li>{@link DomainListener#bind()} is called if v belongs to the
     *          domain and after its removal the domain has a single value</li>
     *          <li>{@link DomainListener#empty()} is called if v is the last value
     *          in the domain i.e. the domain is empty after this operation</li>
     *          </ul>
     */
     ...
     * @param l the methods of the listener are notified as follows:
     *          <ul>
     *          <li>{@link DomainListener#change()} is called if some value is
     *          removed during the operation</li>
     *          <li>{@link DomainListener#changeMax()} is called if v is not equal
     *          to the maximum value</li>
     *          <li>{@link DomainListener#changeMin()} is called if v is not equal
     *          to the minimum value</li>
     *          <li>{@link DomainListener#bind()} is called if v belongs to the
     *          domain and after its removal the domain has a single value</li>
     *          <li>{@link DomainListener#empty()} is called if v is not in the
     *          domain i.e. the domain is empty after this operation</li>
     *          </ul>
     */
     ...
     *          <li>{@link DomainListener#change()} is called if some value is
     *          removed during the operation</li>
     *          <li>{@link DomainListener#changeMax()} is called if v is is larger
     *          than the minimum value</li>
     *          <li>{@link DomainListener#bind()} is called if v is equal to the
     *          maximum value</li>
     *          <li>{@link DomainListener#empty()} is called if v is larger than the
     *          maximum value i.e. the domain is empty after this operation</li>
     *          </ul>
     */
     ...
     *          <li>{@link DomainListener#change()} is called if some value is
     *          removed during the operation</li>
     *          <li>{@link DomainListener#changeMax()} is called if v is is less
     *          than the maximum value</li>
     *          <li>{@link DomainListener#bind()} is called if v is equal to the
     *          minimum value</li>
     *          <li>{@link DomainListener#empty()} is called if v is less than the
     *          minimum value i.e. the domain is empty after this operation</li>
     *          </ul>
     */
    ...
    /**
     * Returns a value in the domain chosen randomly according to the marginal
     * distribution. Based on the stochastic acceptance algorithm described in
    ...
    void setMarginalWithDefault(int v, double m);
     ...
     * @return the size of the domain and {@code dest[0,...,size-1]} contains the
    ...
    /**
     * Return the normalized entropy of the marginal distribution
     * (divided by log(domain.size()))
     */
    ...
    /**
     * Return expected impact computed from registerd impact of all value in the
     * domain
     *
     * @return
     */
